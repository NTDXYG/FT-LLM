...
def train(model_path):
    lm_model = LLM(model_path=model_path, load_adapter_path="None", source_len=128, cutoff_len=256)
    ...
    lm_model.train(train_filename='./dataset/CodeHarmony_train.jsonl', train_batch_size=2, learning_rate=2e-4, 
                        ...
                        eval_batch_size=1, output_dir='./save_models_lora/')
